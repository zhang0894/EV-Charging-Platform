...
struct StationOpt {
    ...
    bool    isOnline = true;      // 服务端 is_online；缺省按在线兼容旧数据
};
...
// 免密登录拿 token（NCS_PHONE 可换号）；loginAs 供测试切换账号
